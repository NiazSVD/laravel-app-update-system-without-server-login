...
@section('title', 'Softvence Food Other User')
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center border-bottom">
            <h3 class="card-title">Other User List</h3>
            @can('user create')
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-lg" id="data-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">No other user found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Add New Other User</h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="editUserForm" method="POST">
                    ...
                    @method('PUT')
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Other User</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
