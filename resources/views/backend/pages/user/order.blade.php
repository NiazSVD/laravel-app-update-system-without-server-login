                ...
                <div class="col-lg-4">
                    <form method="GET" action="{{ route('employee.order.list') }}">
                        <div class="d-flex">
                            ...
                            <button type="submit" class="btn btn-success rounded">Filter</button>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td style="width: 15%;">
                                    <div class="d-flex">
                                        ...
                                        <button
                                            type="button"
                                            class="btn btn-sm btn-info m-1 view-details"
                                            data-order="{{ $order->toJson() }}">
                                            View
                                        </button>

                                        @if($order->order_status === 'pending')
                                            <form action="{{ route('admin.user.order_cancel', $order->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit" class="btn btn-sm m-1 btn-danger">Cancel</button>
                                            </form>
                                        @endif
